 ...
 <div class="wrapper" style="margin-left: 15px; margin-right: 15px;">
	...
	<div class="" style="border: 1px solid #D8D8D8; height: 327px;">
		<div class="" style="margin:0px 15px 5px 15px;height:290px;">
			<div class="">
				<table class="" style="width: 100%;"> <!-- border="solie 1px black" -->
					<thead>                  
					...
					<c:if test="${empty togetherList }">
						<tr>
							<td colspan="5" class="text-center">
								<strong>회원님이 작성한 같이가요 글이 없습니다.</strong>
							</td>
						</tr>
					</c:if>
					<c:if test="${!empty togetherList }">
	                    ...
	                    <tr  align="center" style="border-bottom:1px solid lightgrey;">
	                      	...
	                      	<td width="400px" align="left" style="margin: 5px;padding: 0;"><a href='<%= request.getContextPath()%>/together/detail/?tno=${tList.bno }'>${tList.title}(${tList.comments })</a></td>
		...
		<div class="clearfix">
			<div class="text-center">															
				<ul class="pagination pagination-sm m-0" style="justify-content: center; margin-left: auto; margin-right: auto;"> 
					...
					<li class="page-item">
						<a class="page-link" style="border: 0px; color: black; background: none;" href="together${pageMaker.makeQuery(1)}">&lt;&lt;</a>
					</li>
				
					<li class="page-item">
						<a class="page-link" style="border: 0px; color: black; background: none;" href="together
					...
					<li class="page-item <c:out value="${pageMaker.cri.page == pageNum ?'active':''}"/>">
						<a class="page-link" style="border: 0px; color: black; background: none;" href="together${pageMaker.makeQuery(pageNum) }" >
							${pageNum}</a>
					</li>
					</c:forEach>	
					...
					<li class="page-item">
						<a class="page-link" style="border: 0px; color: black; background: none;" href="together${pageMaker.makeQuery(pageMaker.realEndPage) }">
							&gt;&gt;
						</a>
					</li>
