            ...
            <c:forEach items="${togetherList }" var="together">
                <tr style="border-bottom: 0px solid black;">
                   ...
                   <c:if test="${together.t_state == 1 }">
                    	<td style="width: 16%;  text-align: center"><img src="<%=request.getContextPath()%>/resources/uploadImg/${together.t_writer }/${together.unq_Id }.jpg" style="width:93px;height:70px"></td>
                   </c:if>
                   <c:if test="${together.t_state == 2 }">
                   	 <td style="width: 16%;  text-align: center"><img src="<%=request.getContextPath()%>/resources/images/deadLine1.png" style="width:93px;height:70px"></td>
                    </c:if>
                    <td style="width: 56%;"> 
                        <a href="detail?tno=${together.tno }&listSort=${listSort}&page=${page}">${together.t_title } <c:if test="${together.commentcount>0}">[${together.commentcount }]</c:if></a>
                        <p>${together.t_regDate } ${together.t_writer }</p>
                    </td>
                    <td style=";width: 25%">
