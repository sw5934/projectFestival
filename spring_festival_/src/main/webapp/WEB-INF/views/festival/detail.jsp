 ...
 <style>
    ...
    <div class="col-12" style="overflow:hidden;">
    	<div class="col-8 float-sm-left" style="">
    		...
    		<div class="col-12 " style="border-bottom: 2px solid #666666; padding-bottom: 10px; font-size:1.2em;">
            	<a class="baminfont-Air" style="font-size:1.2em">제목 : </a>${festival.f_title }</div>
    		<div class="col-12 " style="font-size:1.2em; padding: 10px; min-height: 150px;">${festival.f_content }</div> 
            <c:if test="${hashTagList!=null}">
            <div class="col-12">
            	<a class="baminfont-Air" style="font-size:1.4em">해시태그</a>
            	<div class="col-6 mb-3">
            	<c:forEach items="${hashTagList}" var="tag">
            		<a class="mr-3" href="<%=request.getContextPath()%>/festival/list?searchType=hashTag&keyword=">#${tag.hashTag }</a>
            	</c:forEach>
            	</div>
            </div>
            </c:if>
    	...
    	<div class="col-4 float-sm-right">
    		...
    		<div class="col-12 baminfont-Air pl-1 pr-1" style="font-size:1.4em">축제명</div>
    		<div class="col-12 pl-1 pr-1 mb-2" style="font-size:1.1em">${festival.f_name }</div>
    		<div class="col-12 baminfont-Air pl-1 pr-1" style="font-size:1.4em">개최지</div>
    		<div class="col-12 pl-1 pr-1 mb-2" style="font-size:1.1em">${festival.f_location1 } ${festival.f_location2}</div>
    		<div class="col-12 baminfont-Air pl-1 pr-1" style="font-size:1.4em">개최기간</div>
    		<div class="col-12 pl-1 pr-1 mb-2" style="font-size:1.1em">${festival.f_period }</div>
            <c:if test="${festival.scoreAvg!=0}">
	    		<div class="col-12 baminfont-Air pl-1 pr-1" style="font-size:1.4em">후기평점</div>
	    		<div class="col-12 pl-1 pr-1 mb-2" style="font-size:1.1em">${festival.scoreAvg }</div>
    		</c:if>  
    		<c:if test="${festival.f_ref!=null }">
    		<div class="col-12 baminfont-Air pl-1 pr-1" style="font-size:1.4em">웹사이트 보기</div>
    		<div class="col-12 pl-1 pr-1 mb-2" style="font-size:1.1em"><a href="${festival.f_ref }" target="_black" style="color:blue;">축제 사이트 링크로 이동</a></div>
    		</c:if>
    	</div>
    
    </div> 
    <div class="col-12 mb-2" style="padding-bottom: 10px; overflow:hidden;">
    	<div class="float-sm-left col-4 baminfont-Air" align="center">
   		...
   		<div class="float-sm-left col-3 baminfont-Air" align="center">
    ...
    <div class="col-12 mb-2" style="height: 40px; border-bottom: 2px solid #666666; overflow:hidden; justify-content: space-around;">
    ...
    <div class="col-10 mb-3 pb-3" style="margin:0 auto; padding-top: 20px; overflow:hidden">
	    <div class="col-6 p-0 float-left">
	    	...
	    	<button id="reviewBtn" hidden="true" style="float: right; margin-right: 40px; background: none;" class="regist ml-2" onclick="location.href='<%=request.getContextPath()%>/review/reviewRegist?fno=${festival.fno}&f_name=${festival.f_name}'">글 작성하러 가기</button>
	    </div>
	    <div class="col-6 p-0 float-left">
	    	...
	    	<button id="togetherBtn" hidden="true" style="float: right; margin-right: 40px; background: none;" class="regist ml-2" onclick="location.href='<%=request.getContextPath()%>/together/togetherRegist?fno=${festival.fno}&f_name=${festival.f_name}'">글 작성하러 가기</button>
	    </div>
    </div>
